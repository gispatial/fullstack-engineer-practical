            ...
            <TabContent activeTab={this.state.activeTab}>
              <TabPane tabId="1">
                <Row>
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="primary">InventPRO</ToastHeader>
                      <ToastBody>
                  ...
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="success">InventPRO</ToastHeader>
                      <ToastBody>
                  ...
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="info">InventPRO</ToastHeader>
                      <ToastBody>
                  ...
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="danger">InventPRO</ToastHeader>
                      <ToastBody>
                  ...
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="warning">InventPRO</ToastHeader>
                      <ToastBody>
                  ...
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="dark">InventPRO</ToastHeader>
                      <ToastBody>
